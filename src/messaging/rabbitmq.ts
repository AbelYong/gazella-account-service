...
export const ACCOUNT_QUEUE: string = "account_service_queue";
export const WAIT_QUEUE: string = "account_service_wait_queue";
export const DLQ_QUEUE: string = "account_service_dlq";
...
export function getRetryCount(msg: ConsumeMessage): number {
    ...
    const deathEntry = xDeath.find((entry: amqp.XDeath) => entry.queue === ACCOUNT_QUEUE);
